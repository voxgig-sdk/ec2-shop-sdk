...
func NewGetInstancePricingEntity(client *core.Ec2ShopSDK, entopts map[string]any) *GetInstancePricingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetInstancePricingEntity) GetName() string { return e.name }
...
func (e *GetInstancePricingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetInstancePricingEntity) Deleted() bool {
	return e.deleted
}


func (e *GetInstancePricingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetInstancePricingEntity(e.client, opts)
}

func (e *GetInstancePricingEntity) Data(args ...any) any {
...
func (e *GetInstancePricingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetInstancePricingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetInstancePricingEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetInstancePricingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetInstancePricingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetInstancePricingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetInstancePricingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
