...
func (sdk *Ec2ShopSDK) OptionsMap() map[string]any {
...
func (sdk *Ec2ShopSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *Ec2ShopSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *Ec2ShopSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Ec2ShopSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *Ec2ShopSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *Ec2ShopSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("Ec2ShopSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *Ec2ShopSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Ec2ShopSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("Ec2ShopSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
