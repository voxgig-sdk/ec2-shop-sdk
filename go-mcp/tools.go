...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_instance_pricing"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Ec2ShopSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "ec2-shop_list",
		Description: "List records from Ec2Shop. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "ec2-shop_load",
		Description: "Load a single record from Ec2Shop. " +
...
func runOp(client *sdk.Ec2ShopSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Ec2ShopSDK, name string) (sdk.Ec2ShopEntity, error) {
	switch strings.ToLower(name) {
	case "get_instance_pricing":
		return client.GetInstancePricing(nil), nil
