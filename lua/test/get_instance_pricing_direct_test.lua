...
describe("GetInstancePricingDirect", function()
  it("should direct-list-get_instance_pricing", function()
    local setup = get_instance_pricing_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_instance_pricing", setup.live and "live" or "unit")
...
function get_instance_pricing_direct_setup(mockres)
