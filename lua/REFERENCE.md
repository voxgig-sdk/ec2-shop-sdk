# Ec2Shop Lua SDK Reference

Complete API reference for the Ec2Shop Lua SDK.
...
```lua
local results, err = client:GetInstancePricing(nil):list(nil, nil)
```
