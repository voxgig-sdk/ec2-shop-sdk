...
Results: Successful response with instance pricing data.
...
- `InstanceType`: The EC2 instance type (for example, &#39;t2.micro&#39;, &#39;m5.large&#39;)
...
| --- | --- | --- | --- |
| GetInstancePricing | `list` | `GET /` | See reference |

## Connect to the API

- Production server: `https://ec2.shop`
...
- `ec2-shop_list`: List records for an entity. Supported entities: `get_instance_pricing`.
- `ec2-shop_load`: Load one record for an entity. No active entity supports this operation.
