...
class Ec2ShopTestRunner
{
    ...
    {
        $live = self::getenv('EC2_SHOP_TEST_LIVE');
        $override = self::getenv('EC2_SHOP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('EC2_SHOP_TEST_EXPLAIN');
...
class_alias('Ec2ShopTestRunner', 'Runner');
class_alias('Ec2ShopHelpers', 'Helpers');
