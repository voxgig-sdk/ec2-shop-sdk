...
// Ec2Shop SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Ec2ShopSDK::test)
...
{
    private const SDK_CLASS = 'Ec2ShopSDK';
    ...
    private const SDK_BASE = 'ec2shop_sdk';
