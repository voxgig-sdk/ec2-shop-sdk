...
class Ec2ShopRatelimitFeature extends Ec2ShopBaseFeature
{
    ...
    private function _acquire(Ec2ShopContext $ctx): void
    {
    ...
    private function _track(Ec2ShopContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
