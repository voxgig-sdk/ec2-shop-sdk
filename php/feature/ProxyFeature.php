...
class Ec2ShopProxyFeature extends Ec2ShopBaseFeature
{
    ...
    public function init(Ec2ShopContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Ec2ShopContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
