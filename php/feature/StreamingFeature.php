...
class Ec2ShopStreamingFeature extends Ec2ShopBaseFeature
{
    ...
    private function _iterate(Ec2ShopResult $result): \Generator
    {
    ...
    private function _streamable(Ec2ShopContext $ctx): bool
    {
