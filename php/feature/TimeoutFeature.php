...
class Ec2ShopTimeoutFeature extends Ec2ShopBaseFeature
{
    ...
    private function _with_timeout(Ec2ShopContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Ec2ShopContext $_ctx, float $ms): void
    {
        $client = $this->client;
