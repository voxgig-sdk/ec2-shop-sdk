...
class Ec2ShopRbacFeature extends Ec2ShopBaseFeature
{
    ...
    private function _required(Ec2ShopContext $ctx): ?string
    {
    ...
    private function _reject(Ec2ShopContext $ctx, string $required): void
    {
    ...
    private function _track(Ec2ShopContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
