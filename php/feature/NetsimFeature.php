...
class Ec2ShopNetsimFeature extends Ec2ShopBaseFeature
{
    ...
    private function _simulate(Ec2ShopContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Ec2ShopContext $ctx, array $applied): void
    {
        $client = $this->client;
