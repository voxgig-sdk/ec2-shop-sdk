...
// Ec2Shop SDK clienttrack feature
...
class Ec2ShopClienttrackFeature extends Ec2ShopBaseFeature
{
    ...
    public function PostConstruct(Ec2ShopContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Ec2Shop-SDK';
