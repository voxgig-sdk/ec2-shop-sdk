...
// Ec2Shop SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Ec2ShopMakeRequest
{
    public static function call(Ec2ShopContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Ec2ShopResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Ec2ShopResponse($fetched);
        } else {
