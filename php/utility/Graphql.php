...
class Ec2ShopGraphql
{
    ...
    // equivalent.
    public static function body(Ec2ShopContext $ctx): mixed
    {
    ...
    public static function errors(Ec2ShopContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
