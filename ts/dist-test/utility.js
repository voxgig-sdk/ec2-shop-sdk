...
function envOverride(m) {
    if ('TRUE' === process.env.EC2_SHOP_TEST_LIVE ||
        'TRUE' === process.env.EC2_SHOP_TEST_OVERRIDE) {
    ...
    m.EC2_SHOP_TEST_EXPLAIN = process.env.EC2_SHOP_TEST_EXPLAIN || m.EC2_SHOP_TEST_EXPLAIN;
    return m;
}
