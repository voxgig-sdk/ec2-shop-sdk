...
(0, node_test_1.describe)('GetInstancePricingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_instance_pricing', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_instance_pricing', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.EC2_SHOP_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.Ec2ShopSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['EC2_SHOP_TEST_GET_INSTANCE_PRICING_ENTID'];
    ...
    const client = new __1.Ec2ShopSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetInstancePricingDirect.test.js.map