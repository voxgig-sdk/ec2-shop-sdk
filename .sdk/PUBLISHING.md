...
|---|---|---|
| `ts/` | @voxgig-sdk/ec2-shop-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/ec2-shop-sdk \
      --repository voxgig-sdk/ec2-shop-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/ec2-shop-sdk` shows it, and
`npm trust revoke @voxgig-sdk/ec2-shop-sdk --id=<id>` removes it.
