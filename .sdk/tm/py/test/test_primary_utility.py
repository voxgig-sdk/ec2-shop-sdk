...
from projectname_sdk import Ec2ShopSDK
from projectname_sdk.core.spec import Ec2ShopSpec
from projectname_sdk.core.result import Ec2ShopResult
from projectname_sdk.core.response import Ec2ShopResponse
from projectname_sdk.core.operation import Ec2ShopOperation
from projectname_sdk.core.error import Ec2ShopError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import Ec2ShopBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = Ec2ShopSDK.test(None, None)
        ...
        class TestInitFeature(Ec2ShopBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(Ec2ShopBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = Ec2ShopSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = Ec2ShopSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = Ec2ShopSDK.test(None, setup_opts)
