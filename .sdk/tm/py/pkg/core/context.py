...
from projectname_sdk.core.control import Ec2ShopControl
...
class Ec2ShopContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, Ec2ShopResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Ec2ShopError(code, msg, self)
