...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.Ec2ShopSDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.Ec2ShopSDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
