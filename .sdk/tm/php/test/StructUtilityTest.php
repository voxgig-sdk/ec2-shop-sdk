...
// Ec2Shop SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = Ec2ShopOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(Ec2ShopOmni::structfix($now, Struct::undef()))
                        !== json_encode(Ec2ShopOmni::structfix($val, Struct::undef()))) {
