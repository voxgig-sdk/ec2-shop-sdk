...
{
    private static function utility(): Ec2ShopUtility
    {
        return new Ec2ShopUtility();
    }
    ...
    private static function ctx(array $over = []): Ec2ShopContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Ec2ShopContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Ec2ShopOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Ec2ShopError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Ec2ShopOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Ec2ShopMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Ec2ShopOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Ec2ShopMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Ec2ShopOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Ec2ShopMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Ec2ShopSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Ec2ShopMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Ec2ShopResponse([]),
            'result' => new Ec2ShopResult([]),
        ]);
        [, $err] = Ec2ShopMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Ec2ShopSpec([]),
            'response' => null,
            'result' => new Ec2ShopResult([]),
        ]);
        [, $err] = Ec2ShopMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Ec2ShopSpec(['step' => 's']),
            'response' => new Ec2ShopResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Ec2ShopResult([]),
        ]);
        [, $err] = Ec2ShopMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Ec2ShopSpec(['step' => 's']),
            'response' => new Ec2ShopResponse(self::resp(200, ['v' => 1])),
            'result' => new Ec2ShopResult([]),
        ]);
        [, $err] = Ec2ShopMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Ec2ShopSpec(['step' => 's']),
            'response' => new Ec2ShopResponse(self::resp(200, ['v' => 2])),
            'result' => new Ec2ShopResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Ec2ShopMakeResponse::call($ctx);
    ...
    {
        $preset = new Ec2ShopResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Ec2ShopSpec([]),
            'response' => new Ec2ShopResponse([]),
            'result' => new Ec2ShopResult([]),
        ...
        [$got, $err] = Ec2ShopMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Ec2ShopResult([])]);
        [, $err] = Ec2ShopMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Ec2ShopSpec([]), 'result' => null]);
        [, $err] = Ec2ShopMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Ec2ShopSpec(['step' => 's']),
            'result' => new Ec2ShopResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Ec2ShopOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Ec2ShopMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Ec2ShopSpec(['step' => 's']),
            'result' => new Ec2ShopResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Ec2ShopOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Ec2ShopMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Ec2ShopResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Ec2ShopSpec([]),
            'result' => new Ec2ShopResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Ec2ShopMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Ec2ShopMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Ec2ShopError('boom', 'boom');
        $utility->fetcher = function (Ec2ShopContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Ec2ShopSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Ec2ShopMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Ec2ShopContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Ec2ShopMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Ec2ShopResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Ec2ShopContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Ec2ShopSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Ec2ShopMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Ec2ShopResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Ec2ShopSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Ec2ShopMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Ec2ShopMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Ec2ShopMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Ec2ShopResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Ec2ShopDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Ec2ShopResult(['ok' => false])]);
        $this->expectException(Ec2ShopError::class);
        Ec2ShopDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Ec2ShopResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Ec2ShopMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Ec2ShopMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Ec2ShopBaseFeature();
        $b = new Ec2ShopBaseFeature();
        Ec2ShopFeatureAdd::call($ctx, $a);
        Ec2ShopFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Ec2ShopBaseFeature
    {
        $f = new Ec2ShopBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Ec2ShopFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Ec2ShopContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Ec2ShopSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Ec2ShopPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Ec2ShopResponse(['headers' => null]),
            'result' => new Ec2ShopResult([]),
        ]);
        Ec2ShopResultHeaders::call($ctx);
