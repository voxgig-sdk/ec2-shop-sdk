...
// Ec2Shop SDK utility: fetcher

class Ec2ShopFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Ec2ShopSDK/1.0)';
    ...
    public static function call(Ec2ShopContext $ctx, string $fullurl, array $fetchdef): array
    {
