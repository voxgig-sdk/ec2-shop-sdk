...
// Ec2Shop SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Ec2ShopParam
{
    public static function call(Ec2ShopContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Ec2ShopHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
