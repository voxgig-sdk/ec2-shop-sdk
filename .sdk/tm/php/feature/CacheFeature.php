...
class Ec2ShopCacheFeature extends Ec2ShopBaseFeature
{
    ...
    private function _through(Ec2ShopContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
