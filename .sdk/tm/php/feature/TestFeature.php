...
// Ec2Shop SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Ec2ShopTestFeature extends Ec2ShopBaseFeature
{
    ...
    public function init(Ec2ShopContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Ec2ShopContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Ec2ShopContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Ec2ShopContext $ctx, $op, $args): array
    {
