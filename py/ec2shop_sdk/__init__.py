...
from ec2shop_sdk.utility import register

# Load features
from ec2shop_sdk.feature.base_feature import Ec2ShopBaseFeature
from ec2shop_sdk.features import _has_feature, _make_feature
...
class Ec2ShopSDK:
    ...
    def get_utility(self):
        return Ec2ShopUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Ec2ShopSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetInstancePricing(self, data=None) -> "GetInstancePricingEntity":
        ...
        from ec2shop_sdk.entity.get_instance_pricing_entity import GetInstancePricingEntity
