...
from ec2shop_sdk.ec2shop_types import (
    GetInstancePricing,
...
class GetInstancePricingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetInstancePricingEntity(self._client, opts)
    ...
    def data_get(self) -> GetInstancePricing:
    ...
    def match_get(self) -> GetInstancePricing:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetInstancePricing]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetInstancePricing().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
