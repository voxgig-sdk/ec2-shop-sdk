...
class Ec2ShopTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Ec2ShopTestRunner.getenv("EC2SHOP_TEST_LIVE")
        override = Ec2ShopTestRunner.getenv("EC2SHOP_TEST_OVERRIDE")
        ...
        explain = Ec2ShopTestRunner.getenv("EC2SHOP_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["EC2SHOP_TEST_EXPLAIN"] = explain
