# Ec2Shop SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Ec2ShopSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Ec2ShopSDK(...) and Ec2ShopSDK.test(...) become
#      Ec2ShopSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "ec2shop_sdk"
_SDK_CLASS = "Ec2ShopSDK"
...
_ENTITIES = {
    "GetInstancePricing": "get_instance_pricing",
}
