...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetInstancePricing()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/ec2-shop-sdk/releases)) or
