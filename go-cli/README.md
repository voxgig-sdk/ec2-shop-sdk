...
AQL-driven CLI and REPL for the Ec2Shop SDK. Positional arguments are
...
./ec2-shop-cli load 1 get_instance_pricing
./ec2-shop-cli load '{id:1}' get_instance_pricing
