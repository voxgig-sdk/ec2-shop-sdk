...
func registerSDKWords(r *eng.Registry, client *sdk.Ec2ShopSDK) {
...
func runOp(client *sdk.Ec2ShopSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
