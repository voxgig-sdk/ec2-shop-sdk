# Ec2Shop Ruby SDK Reference

Complete API reference for the Ec2Shop Ruby SDK.
...
#### `Ec2ShopSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.GetInstancePricing.list(nil)
```
