...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = Ec2ShopOmni.make_runner(TEST_JSON_FILE, Ec2ShopSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : Ec2ShopOmni.errify(err)
    end
